...
case_root="${case_root:-/data2/Model_Output/ctsm_runs/single_point/qli1/medlyn/sitecomp1123/Ken}"
...
fates_param="${fates_param:-fates_params_medlyn_g1_5.04.nc}"  # !!this may not be a good idea as this file can change!! may need to define explicitly
