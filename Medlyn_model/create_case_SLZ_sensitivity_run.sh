...
case_root="${case_root:-/data2/Model_Output/ctsm_runs/single_point/qli1/medlyn/sensitivity0815/QBOT}"
...
met_end="${met_end:-2000}"
resolution="${resolution:-0.9x1.25}"

# show options
datm_data_root=/data/Model_Data/cesm_input_datasets/single_point_synthetic_met/${site_name}/QBOT  #folder CO2 is for CO2 scenario, folder Solar is for Radiation scenario, 
#folder QBOT is for VPD scenario, folder TPHWL is for Temperature scenario 
